...
function validation() {
	...
	<div class="header row">
		...
		<div >
			<a href="/logout" onclick="return confirm('Are you sure you want to LOGOUT ?')"class="btn btn-danger">Logout</a>
		</div>
	</div>
	...
	<div class="row justify-content-center">
                 ...
                 <form action="addBranch" method="post" id="branchForm" onsubmit="return validation()">
                 <table class="table">
                 <tbody>
                 <tr>
                 <td><label for="branchName">Branch Name</label></td>
                 <td><input type="text" form="branchForm" placeholder="Branch Name" name="branchName" id="branchName" required></td>
                 </tr>
                 <tr>
                 <td><label for="branchName">Branch Manager</label></td>
                 <td><input type="text" form="branchForm" placeholder="Branch Manager" name="branchManager" id="branchManager" required></td>
                 </tr>
                 <tr>
                 <td><label for="branchName">Branch Address</label></td>
                 <td><textarea form="branchForm" placeholder="Branch Address" name="branchAddress" id="branchAddress" required></textarea></td>
                 </tr>
                 <tr>
                 <td><label for="branchName">Branch IFSC-Code</label></td>
                 <td><input type="text" form="branchForm" placeholder="IFSC-CODE" name="IFSC_Code" id="IFSC_Code" required></td>
                 </tr>
                 
                 </tbody>
                 </table>
                 <button class="btn custom-btn btn-block" form="branchForm">Add Branch</button>
                 </form>
